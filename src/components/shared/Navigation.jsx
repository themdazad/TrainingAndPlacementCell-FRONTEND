...
export default function NavBar() {
  ...
  return (
    <nav
      className={`sticky top-0 m-auto z-[99] ${
    ...
    >
      <div className="max-w-[1980px] m-auto ">
        ...
        <header className="navHeader px-[5%] py-4 bg-white dark:bg-zinc-900 min-h-[100px] flex justify-between items-center">
          <div className="flex flex-wrap justify-center items-center gap-3 md:gap-6 lg:gap-12">
            <div className="college-logo aspect-square">
              <Image
            ...
            <div className="title max-sm:text-center">
              <h1 className=" dm-serif-text-regular text-3xl font-bold">
