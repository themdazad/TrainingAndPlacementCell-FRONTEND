      ...
      <div className="relative mx-auto">
        ...
        >
          ...
          {visibleTestimonials.map((t, index) => (
            ...
            >
              <p className="text-slate-800 dark:text-slate-100 mb-4 leading-relaxed">{t.text}</p>
              <div>
                <p className="font-semibold text-slate-900 text-sm dark:text-white">{t.name}</p>
                <p className="text-slate-600 dark:text-slate-400 text-sm mb-2">{t.title}</p>
