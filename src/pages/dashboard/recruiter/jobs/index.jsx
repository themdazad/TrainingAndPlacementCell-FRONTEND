        ...
        <div className="flex justify-between items-start gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <Chip color={statusColorMap[job.status] || 'default'} variant="flat" size="sm">
                {job.status}
              </Chip>
            ...
            <p className="text-default-500 text-sm mt-1 line-clamp-2">{job.description}</p>
          ...
          <Dropdown>
            ...
            <DropdownMenu aria-label="Job actions">
              ...
              <DropdownItem
                key="applications"
                as={Link}
                to={`${PATHS.RECRUITER.JOBS}/${job._id}/applications`}
              >
                View Applications
              </DropdownItem>
              {job.status === 'Draft' && (
