    ...
    <Card className="h-full hover:shadow-lg transition-shadow">
      <CardBody className="p-4">
        <div className="flex gap-4">
          <div
            className={`p-3 rounded-xl bg-${getTypeColor(resource.type)}/10 text-${getTypeColor(resource.type)} flex-shrink-0`}
          >
            {getResourceIcon(resource.type)}
          </div>
          <div className="flex-1 min-w-0">
            <Chip color={getTypeColor(resource.type)} variant="flat" size="sm" className="mb-2">
              {resource.type}
            </Chip>
            <h3 className="font-semibold text-lg line-clamp-1">{resource.title}</h3>
            <p className="text-sm text-default-500 line-clamp-2 mt-1">{resource.description}</p>
            ...
            <div className="flex items-center gap-4 mt-3 text-sm text-default-400">
              ...
              <span className="ml-auto">{getRelativeTime(resource.createdAt)}</span>
            </div>
          </div>
        </div>
      </CardBody>
