...
export default function VisionMission() {
  return (
    <section className="min-h-[100px] dark:bg-gray-900 px-[5%] my-[100px] transition-colors duration-300">
      <div className="academic-program grid gap-16">
        <div className="academic-program__title text-center">
          <h1 className="font-extrabold text-lg md:text-3xl text-gray-900 dark:text-white">
            Academic Programs
          </h1>
          ...
          {cards.map((card, index) => {
            ...
            return (
              <motion.div
                key={index}
                variants={item}
                className="academic-program__item flex flex-col items-center justify-center gap-4 text-center border-t-4 border-blue-500 p-6 bg-blue-100 dark:bg-gray-800 rounded-3xl hover:shadow-lg transition-all duration-300"
              >
                ...
                <div className="academic-program__item-description text-sm text-gray-700 dark:text-gray-300">
                  {card.description}
                </div>
              </motion.div>
            );
