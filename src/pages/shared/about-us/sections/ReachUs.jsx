    ...
    <section className="m-auto px-[5%] grid grid-cols-1 gap-6">
      ...
      <div className="contact-info mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {transportModes.map(({ mode, icon, description, cities }) => (
          <div
            key={mode}
            className="card bg-gray-100/50 hover:shadow-md p-6 dark:bg-gray-800 rounded-3xl"
          >
      ...
      {/* Accommodation  */}
      <div className="bg-gray-100/50 hover:shadow-md p-6 dark:bg-gray-800 rounded-3xl max-w-full">
        ...
        <p>
          ...
          accommodation facilities for visiting faculty, recruiters, and guests
          through its dedicated guest house. This facility ensures a comfortable
          stay within the college premises, facilitating easy access to campus
          activities.
        </p>

        <ul className="list-disc list-inside mt-4 space-y-2">
          <li>
            <strong>Location:</strong> Within the campus at
