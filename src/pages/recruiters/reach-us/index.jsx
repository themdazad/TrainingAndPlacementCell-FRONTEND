  ...
  return (
    <main className=" dark:bg-neutral-900 grid gap-12">
      <div className="m-auto max-w-screen-2xl px-[2.5%] ">
        ...
        <section className="grid grid-cols-1 gap-4 lg:gap-12 py-6">
          {/* Travel cards */}
          ...
          <div className="shadow-md p-6 dark:bg-neutral-800 rounded-3xl max-w-full">
            ...
            <ul className="list-disc list-inside mt-4 space-y-2">
              ...
              <li>
                <strong>Facilities:</strong> The guest house offers
                well-furnished rooms equipped with essential amenities to ensure
