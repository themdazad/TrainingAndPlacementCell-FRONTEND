...
export default function Gallery() {
  return (
    <main className="min-h-screen bg-white dark:bg-neutral-900 text-neutral-800 dark:text-neutral-100">
      <div className="m-auto max-w-screen-2xl px-[5%] sm:px-[4%] space-y-10 lg:space-y-20 py-10">
        ...
        <div className="relative overflow-hidden rounded-3xl shadow-md">
          ...
          />
          <div className="max-md:hidden absolute inset-0 bg-gradient-to-t from-neutral-200/70 to-neutral-200/0 dark:from-neutral-800/70 dark:to-neutral-800/0  py-10  flex flex-col justify-end text-center px-4">
        ...
        {galleryData.map((yearBlock, i) => (
          <section key={i} className="space-y-8">
            <h2 className="text-2xl sm:text-3xl font-bold border-b pb-2 border-neutral-300 dark:border-neutral-700">
              Year {yearBlock.year}
            </h2>
                ...
                {event.type === "upload" && (
                  <div className="columns-1 sm:columns-2 md:columns-3 gap-4 space-y-4">
                    {event.images.map((src, imgIdx) => (
                      <div
                        key={imgIdx}
                        className="break-inside-avoid rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition duration-300 bg-white dark:bg-neutral-800"
                      >
                        <Image
                          src={src}
