...
export default function MockInterview() {
  ...
  return (
    <main className="max-w-screen-2xl px-[2%] m-auto dark:bg-slate-900 grid gap-12 py-6 ">
      ...
      <section>
        <div className="lastest-mock-interview-section grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="grid content-center">
            <div className="bg-blue-100 dark:bg-slate-800 rounded-3xl shadow-md p-8 grid gap-3 text-center  w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 py-6">
          {mock_interview_data.map((data, index) => {
            return (
              <div
                key={index}
                className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-8 grid gap-3 text-center  w-full"
              >
