    ...
    <div className="dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-100 transition-colors duration-300 py-8">
      <div className="flex flex-col lg:flex-row gap-8 mx-auto">
        ...
        <div className="w-full lg:w-1/2 p-6 rounded shadow overflow-auto max-h-[90vh] space-y-6 bg-white dark:bg-gray-900">
          ...
          {/* Personal Info */}
          <section className="p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800 space-y-4">
            <h3 className="text-lg font-semibold text-blue-500">
              Personal Information
            </h3>
            {["name", "title", "email", "phone", "location"].map((field) => (
              <div key={field}>
                <label className="block mb-1 capitalize font-medium text-gray-700 dark:text-gray-200">
                  {field}
                </label>
                <input
                  type="text"
          ...
          {/* Skills */}
          <section className="p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
          ...
          <section className="p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
            ...
            {education.map((edu, i) => (
              <div
                key={i}
                className="mb-4 border border-gray-300 dark:border-gray-600 rounded p-4 bg-white dark:bg-gray-700 space-y-2"
              >
                <div className="flex gap-4">
                  ...
                  <input
                    ...
                    className="flex-2 p-2 border border-gray-300 dark:border-gray-600 rounded"
                  />
                </div>
          ...
          <section className="p-4 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-800">
            ...
            {experience.map((exp, i) => (
              <div
                key={i}
                className="mb-6 border border-gray-300 dark:border-gray-600 rounded p-4 bg-white dark:bg-gray-700 space-y-2"
              >
                <div className="flex gap-4">
                  <input
                    type="text"
        ...
        <div
          ref={resumeRef}
          className="w-full lg:w-1/2 bg-white dark:bg-gray-800 text-black dark:text-gray-100 p-16 rounded shadow font-sans text-sm overflow-auto max-h-[90vh]"
        >
          {/* Preview header */}
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
