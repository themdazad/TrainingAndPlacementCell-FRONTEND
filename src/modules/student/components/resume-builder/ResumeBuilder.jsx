    ...
    <div className="dark:bg-slate-900 min-h-screen text-slate-800 dark:text-slate-100 transition-colors duration-300 py-8">
      <div className="flex flex-col lg:flex-row gap-8 mx-auto">
        ...
        <div className="w-full lg:w-1/2 p-6 rounded shadow overflow-auto max-h-[90vh] space-y-6 bg-white dark:bg-slate-900">
          ...
          {/* Personal Info */}
          <section className="p-4 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800 space-y-4">
            <h3 className="text-lg font-semibold text-blue-500">
              Personal Information
            </h3>
            {["name", "title", "email", "phone", "location"].map((field) => (
              <div key={field}>
                <label className="block mb-1 capitalize font-medium text-slate-700 dark:text-slate-200">
                  {field}
                </label>
                <input
                  type="text"
          ...
          {/* Skills */}
          <section className="p-4 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800">
            ...
            {skills.map((skill, i) => (
              <div key={i} className="flex mb-2 items-center">
                <input
                  ...
                  className="flex-grow p-2 border border-slate-300 dark:border-slate-600 rounded bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                />
                <button
          ...
          <section className="p-4 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800">
            ...
            {education.map((edu, i) => (
              <div
                key={i}
                className="mb-4 border border-slate-300 dark:border-slate-600 rounded p-4 bg-white dark:bg-slate-700 space-y-2"
              >
                <div className="flex gap-4">
                  ...
                  <input
                    ...
                    className="flex-2 p-2 border border-slate-300 dark:border-slate-600 rounded"
                  />
                </div>
          ...
          <section className="p-4 border border-slate-300 dark:border-slate-700 rounded-lg bg-slate-50 dark:bg-slate-800">
            ...
            {experience.map((exp, i) => (
              <div
                key={i}
                className="mb-6 border border-slate-300 dark:border-slate-600 rounded p-4 bg-white dark:bg-slate-700 space-y-2"
              >
                <div className="flex gap-4">
                  <input
                    type="text"
            ...
            {achievements.map((ach, i) => (
              <div key={i} className="flex mb-2 items-center">
                <input
                  ...
                  className="flex-grow p-2 border rounded bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                />
                <button
        ...
        <div
          ref={resumeRef}
          className="w-full lg:w-1/2 bg-white dark:bg-slate-800 text-black dark:text-slate-100 p-16 rounded shadow font-sans text-sm overflow-auto max-h-[90vh]"
        >
          {/* Preview header */}
          <div className="mb-6">
            <div className="flex justify-between items-center mb-4">
